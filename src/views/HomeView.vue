<template>
  <div class="home">
    ...
    <FlashSale
      :products="productsStore.flashSaleProducts"
    ...
    <BrowseCategory
      :categories="productsStore.browseCategories"
      :active-category="productsStore.activeCategory"
    ...
    <ExploreProducts
      :products="productsStore.exploreProducts"
      @go-to-product="goToProduct"
      @add-to-cart="handleAddToCart"
      @add-to-wishlist="addToWishlist"
    />
...
// static data — plain const instead of data()
...
function handleSetActiveCategory(slug: string): void {
  productsStore.setActiveCategory(slug);
  productsStore.filterByCategory(slug);
}
